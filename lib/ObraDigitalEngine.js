...
var MotorNeodata = {
  ...
  calcularCostosEspeciales: function(metros_cuadrados, niveles, id_tipologia) {
    ...
    if (id_tipologia === "fit_out_comercial" || id_tipologia === "local_comercial" || id_tipologia === "restaurante") {
      ...
      var minisplit = this.insumos.equipamiento_especial.minisplit_2_ton;
      ...
      if (metros_cuadrados > 50) {
        var cableado = this.insumos.instalaciones.cable_trifasico_8;
...
if (typeof module !== 'undefined') module.exports = MotorNeodata;